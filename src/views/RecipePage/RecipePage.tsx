      ...
      <Container maxWidth="md" style={{ marginTop: "40px" }}>
        <Paper elevation={3} style={{ padding: "30px" }}>
          ...
          <section style={{ marginTop: "30px" }}>
            ...
            <List>
              <ListItem>
                <ListItemText primary="Step 1: Lorem ipsum dolor sit amet." />
              </ListItem>
              <ListItem>
                <ListItemText primary="Step 2: Consectetur adipiscing elit." />
              </ListItem>
              <ListItem>
                <ListItemText primary="Step 3: Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." />
              </ListItem>
